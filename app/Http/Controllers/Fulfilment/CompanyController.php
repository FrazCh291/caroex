...
class CompanyController extends Controller
{
    ...
    {
        $this->authorize('viewAnycompany', Company::class);
        ...
        return Inertia::render('Fulfilment/Companies/Index', [
    ...
    public function showCompany(Company $company)
    {
        ...
        return Inertia::render('Fulfilment/Companies/Show', [
            'company' => $company
        ]);
    }
    ...
    public function create()
    {
        ...
        return Inertia::render('Fulfilment/Companies/Create', [
    ...
    {
        return Inertia::render('Fulfilment/Addresses/Create', [
            'companyId' => $id
        ]);
    }
    ...
    {                
        ...
        return Redirect::route('company.show', $company->id)->with('success', 'Company address created successfully');
    }
    ...
    {
        $this->authorize('viewcompany', Company::class);
    ...
    {
        // $this->authorize('upadatecompany', Company::class);
    ...
    public function updateAddress(Request $request, $id)
    {
        ...
        return Redirect::route('company.show', $address->addressable_id)->with('success', 'Adreess updatedd successfully');
    }
    ...
    {
        $this->authorize('deletecompany', Company::class);
        ...
        return Redirect::route('company.index', [$addresses, $benificiary, $intermediaries, $shippments, $shipmentItems])->with('success', 'Record deleted successfully');
    }
    ...
    public function addressDelete($id)
    {
        ...
        return Redirect::route('company.show', $company_id)->with('success', 'Addres deleted successfully');
    }
    ...
    public function CompanyRoles($id)
    {
        ...
        return Inertia::render('Fulfilment/Companies/Roles/Index', [
            'company' => $company
        ]);
    }
    ...
    public function companyModulesPermissions($id)
    {
        ...
        return Inertia::render('Fulfilment/Companies/Roles/Role_permission', [
            'modules' => $modules,
            'role' => $role
        ]);
    }
