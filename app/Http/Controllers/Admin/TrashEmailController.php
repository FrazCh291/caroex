...
class TrashEmailController extends Controller
{
...
//        $emailFatchs = $trashFolder->messages()->all()->limit(500)->get();
...
//        }
////        }
//        $emails = Email::with('attachments', 'inlineAttachments')->where('folder', 'Trash')
