    ...
    <admin-layout>
        <div class="col-12 px-0">
            <div class="col form-group p-0">
                <inertia-link :href="route('packages.create')" class="btn btn-primary" data-repeater-create="">
                    Add Package
                </inertia-link>
            </div>
        </div>
                                                 ...
                                                 <div class="col-12 pl-2 pt-1">
                                                    ...
                                                    <div class="align-items-center text-base pt-1">
                                                        <p class="tag">
                                                            ...
                                                            <label class="pl-1 py-0 my-0" for="active">Active</label>
                                                        </p>
                                                        <p class="tag">
                                                            <input type="checkbox" name="inactive" id="inactive"
                                                                   v-model="query.inactive">
                                                            <label
                                                                class="pl-1 py-0 my-0" for="inactive">Inactive</label>
                                                        </p>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="align-items-center text-base">
                                                        <p class="tag">
                                                            <input type="checkbox" name="duration" id="duration"
                                                                   v-model="query.duration" v-on:click="check_one()">
                                                            <label class="pl-1 py-0 my-0" for="duration">Duration</label>
                                                        </p>
                                                    </div>
                                                    <div class="align-items-center text-base">
                                                        <p class="tag">
                                                            <input type="checkbox" name="number_of_user" id="number_of_user"
                                                                   v-model="query.number_of_user" v-on:click="check_one()">
                                                            <label class="pl-1 py-0 my-0" for="number_of_user">Number of User</label>
                                                        </p>
                                                    </div>
                                                    <div class="align-items-center text-base">
                                                        <p class="tag">
                                                            <input type="checkbox" name="price" id="price"
                                                                   v-model="query.price" v-on:click="check_one()">
                                                            <label class="pl-1 py-0 my-0" for="	price">Price</label>
                                                        </p>
                                                         <p class="tag">
                    ...
                    <div class="card-content">
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                <tr v-for="packagee in packages.data">
                                    <td class="text-left pl-2">{{packagee.name}}</td>
                                    <td class="text-center">{{packagee.duration}}</td>
                                    <td class="text-center">{{packagee.number_of_user}}</td>
                                    <td class="text-right">£{{packagee.price}}</td>
                                    <td class="text-center">
                                        <span v-if="packagee.status == '1'" class="badge badge-light-success badge-pill">Active</span>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <a :href="route('packages.edit',packagee.id)" class="dropdown-item"><i class="bx bx-edit-alt mr-1"></i>Edit</a>
                                        <a class="dropdown-item" v-on:click="confirmDelete(packagee.id)"><i class="bx bx-trash mr-1"></i>Delete</a>
                                        </div>
                                        </div>
                                    </td>
                                </tr>
...
export default {
    ...
    methods: {
        ...
        deleteItem() {
            this.sweetAlert = false
            this.$inertia.delete(`/super/admin/packages/${this.itemId}`)
        },
        confirmDelete(id) {
        ...
        resetSort(e) {
            ...
            this.query.duration = false;
            this.query.number_of_user = false;
            this.query.price = false;
        ...
        check_one: function () {
                if ((this.query.name = false)) {
                    ...
                    this.query.duration = [];
                    this.query.number_of_user = [];
                    this.query.price = [];
                    this.query.status = [];
                }
                if ((this.query.duration = false)) {
                    this.query.duration = true;
                    this.query.name = [];
                    this.query.number_of_user = [];
                    this.query.price = [];
                    this.query.status = [];
                }
                if ((this.query.number_of_user = false)) {
                    this.query.number_of_user = true;
                    this.query.name = [];
                    this.query.duration = [];
                    this.query.price = [];
                    this.query.status = [];
                }
                if ((this.query.price = false)) {
                    this.query.price = true;
                    this.query.name = [];
                    this.query.number_of_user = [];
                    this.query.duration = [];
                    this.query.status = [];
        ...
        loadData() {
            ...
            this.$inertia.visit(route('packages.index'), {
                method: 'get',
                data: {
                    ...query
                }
