                    ...
                    <form @submit.prevent="submit"
                        ...
                        <div class="card mt-2  mb-1">
                          ...
                          <div class="col-sm-11 d-flex justify-content-start px-3 pb-2 pt-1">
                            ...
                            <inertia-link :href="route('cases.index')" type="button"
...
export default {
    ...
    methods: {
            ...
            if (this.emailId) {
                ...
                this.$inertia.visit('/erp/cases', {
                    ...
                    data: {
                        order_id: this.orderId,
                        product_id: this.productId,
                        // searchString:this.params.query
                    }
                })
            }
        ...
        loadData() {
            ...
            this.$inertia.visit(route('cases.create'), {
                method: 'get',
                data: {
                    ...query
                }
