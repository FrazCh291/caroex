                                    ...
                                    <form class="form form-horizontal" @submit.prevent="send">
                                        <div class="form-body">
                                            ...
                                            <div class="row form-group py-0 my-0">
                                                ...
                                                <div class="col-md-3 form-group">
                                                    <select v-model="form.invoiceable_id" class="form-select"
                                                            name="invoiceable_id">
                                                        <option value="">select</option>
                                                        <option v-for="shipment in shipments" :value="shipment.id">
                                                            {{ shipment.container_number?shipment.container_number:shipment.order_number }}
                                                        </option>
                                                    </select>
                                                    <ErrorComponent input="invoiceable_id"></ErrorComponent>
                                                </div>
                                            </div>
                                            <div class="row form-group py-0 my-0">
                                                <div class="col-md-7">
                                            ...
                                            <div class="row form-group py-0 my-0">
                                                ...
                                                <div class="col-md-3 form-group">
                                                    <select v-model="form.currency" class="form-select" name="currency">
                                                        <option value="">Select</option>
                                                        <option v-for="currencies in this.currencys"
                                                                :value="currencies.slug">
                                                            {{ currencies.value }}
                                                        </option>
                                                    </select>
...
<!--                                                        readonly/>-->
                                                                    ...
                                                                    <table class="table table-hover truncate mb-0">
                                                                        ...
                                                                        <tr v-for="invoiceItem in this.invoiceItems"
                                                                            ...
                                                                            <td class="text-center">{{
                                                                                    invoiceItem.currency?invoiceItem.currency.toUpperCase().substr(invoiceItem.currency.length -3 , invoiceItem.currency.length)  + ' ' + invoiceItem.total:''
                                                                                }}
                                                                            </td>
                                                                            <td class="text-right">
                                                                            <div class="dropdown">
                                                                            ...
                                                                            <a class="dropdown-item"   data-target="#addItem" data-toggle="modal" v-on:click="editInvoiceItem(invoiceItem.id)"><i class="bx bx-edit-alt mr-1"></i>Edit</a>
                                                                            <a class="dropdown-item"   v-on:click="deleteInvoiceItem(invoiceItem.id)"><i class="bx bx-trash mr-1"></i>Delete</a>
                                                                            </div>
                                                                            </div>
                                                                            </td>
                                                                        </tr>
                                                        ...
                                                        <div class="card pr-0 pb-0 mb-1">
                                                            <div class="card-content">
                                                                <div class="table-responsive">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item"  data-target="#addDocs"  data-toggle="modal" v-on:click="editInvoiceDocs(invoiceDoc.id)"><i class="bx bx-edit-alt mr-1"></i>Edit</a>
                                                                    <a class="dropdown-item"  v-on:click="deleteInvoiceDoc(invoiceDoc.id)"><i class="bx bx-trash mr-1"></i>Delete</a>
                                                                    </div>
                                                                    </div>
                                                                            </td>
                                                                        </tr>
                                            ...
                                            <div class="col-sm-11 d-flex justify-content-start px-0">
                                                  <button class="btn btn-primary mr-1 mb-1" type="label" v-if="this.invoiceItems.length>0">
                                                    Save
                                                </button>
                                                <button class="btn btn-primary mr-1 mb-1" type="label" v-else disabled>
                                                    Save
                                                </button>
                                        ...
                                        <div
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form
                                                    ...
                                                    <li v-for="error in errors" class="error pt-1">{{ error }}</li>
                                                    <div class="modal-body mb-1">
                                                        ...
                                                        <div class="form-group my-0 mb-1">
                                                            <label>Currency *</label>
                                                            <select v-model.lazy="form1.currency" class="form-control" required>
                                                                <option value="">Select</option>
...
export default {
    name: "Create",
    props: ['shipments', 'customers', 'errors', 'currencys', 'suppliers', 'products', 'statuses', 'invoiceItem', 'invoice', 'documents', 'routeName', 'routeId'],
    ...
    beforeMount() {
        ...
        if (this.invoice) {
            ...
            this.form.currency =  this.invoice.currency?this.invoice.currency.toLowerCase():''
        }
    },
    methods: {
        send() {
