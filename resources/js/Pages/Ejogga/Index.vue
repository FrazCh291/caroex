    ...
    <admin-layout>
        ...
        <div class="row pb-3" id="table-hover-row">
                                ...
                                <div class="tabbable-responsive">
                                    <div class="tabbable">
                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                            ...
                                            <li class="nav-item" v-if="hasPermission('ejoggas.index')">
                                                <a class="nav-link active" aria-selected="true" id="first-tab"
                                                   aria-controls="first"
                                                   data-toggle="tab" href="#first" role="tab">Ejogga</a>
                                            </li>
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right py-0 my-0 custom-dropdown"
                                                ...
                                                <div class="col-12 pl-2 pt-1">
                                                    ...
                                                    <div class="align-items-center text-base pt-1">
                                                        <p class="tag">
                                                            <input type="checkbox" name="order_number" id="order_number"
                                                                   v-model="query.order_number">
                                                            <label class="pl-1 py-0 my-0" for="order_number">ORDER
                                                                NUMBER</label>
                                                        </p>
                                                    </div>
                                                    <div class="align-items-center text-base pt-1">
                                                        <p class="tag">
                                                            <input type="checkbox" name="item_name" id="item_name"
                                                                   v-model="query.item_name">
                                                            <label class="pl-1 py-0 my-0" for="item_name">PRODUCT
                                                                NAME</label>
                                                        </p>
                                                    </div>
                                                    <div class="align-items-center text-base pt-1">
                                                        <p class="tag">
                                                            ...
                                                            <label class="pl-1 py-0 my-0" for="billing_first_name">CUSTOMER
                                                                NAME</label>
                                                        </p>
                                                    </div>
                                                    <div class="align-items-center text-base pt-1">
                                                    ...
                                                    <div class="align-items-center text-base pt-1">
                                                        <p class="tag">
                                                            ...
                                                            <label class="pl-1 py-0 my-0" for="shipping_address_1_2">ADDRESS</label>
                                                        </p>
                                                    </div>
                                                </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-content">
                        <div class="table-responsive"  v-if="ejoggas.data.length>0">
                            <table class="table table-hover mb-0">
                                <thead>
                                <tr>
                                    <th class="text-truncate">Order Number</th>
                                ...
                                <tbody>
                                <tr v-for="ejogga in ejoggas.data">
                                    <td class="text-truncate">{{ ejogga.order_number }}</td>
                                    <td class="text-truncate">{{ ejogga.item_name }}</td>
                                    <td class="text-truncate">{{
                                            (ejogga.shipping_first_name ? " " + ejogga.shipping_first_name : '') +
                                            (ejogga.shipping_last_name ? " " + ejogga.shipping_last_name : '')
                                        }}
                                    </td>
                                    <td class="text-truncate">{{ ejogga.billing_email }}</td>
                                    <td class="text-truncate">{{ ejogga.billing_phone }}</td>
                                    <td class="text-truncate">{{
                                            (ejogga.shipping_address_1_2 ? " " + ejogga.shipping_address_1_2 : '') +
                                            (ejogga.shipping_city ? "  " + ejogga.shipping_cit : '') +
                                            (ejogga.shipping_state_code ? "  " + ejogga.shipping_state_code : '') +
                                            (ejogga.shipping_postcode ? "  " + ejogga.shipping_postcode : '')
                                        }}
                                    </td>
                                    <td class="text-truncate">{{
                                            ejogga.order_date ? formatDate(ejogga.order_date) : ''
                                        }}
                                    </td>
                                </tr>
                                </tbody>
                        ...
                        <div class="table-responsive" v-else>
                            <table class="table table-hover truncate text-center mb-0">
                                <thead class="mb-5 pb-5">
                                <tr class="text-center mb-5 pb-5">
                                    <h4 class="pt-3">
                                        It's seems like you don't have any Ejogga Order!</h4>
            ...
            <div class="col-12 ">
                <pagination :links="ejoggas.links" class="float-right"></pagination>
            </div>
        </div>
    </admin-layout>
</template>
...
export default {
    ...
    beforeMount() {
        document.title = process.env.MIX_APP_NAME + " - Ejogga";
    },
    ...
    methods: {
        ...
        deleteItem() {
            this.sweetAlert = false
            this.$inertia.delete(`/ejoggas/${this.itemId}`)
        },
        confirmDelete(id) {
        ...
        loadData() {
            ...
            this.$inertia.visit(route('ejoggas.index'), {
                method: 'get',
                data: {
                    ...query
                }
