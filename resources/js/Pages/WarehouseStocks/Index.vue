<template>
    <admin-layout>
        ...
        <div class="row pb-3" id="table-hover-row">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right py-0 my-0 custom-dropdown"
                                                ...
                                                <div class="col-12 pl-2 pt-2">
                                                    ...
                                                    <div class="align-items-center text-base pt-1">
                                                        <p class="tag">
                                                            <input type="checkbox" name="name" id="product_id"
                                                                   v-model="query.product_id" v-on:click="check_one()">
                                                            <label class="pl-1 py-0 my-0" for="product_id">Product
                                                                Name</label>
                                                        </p>
                                                    </div>
                                                    <div class="align-items-center text-base ">
                                                        <p class="tag">
                                                            <input type="checkbox" name="name" id="warehouse_id"
                                                                   v-model="query.warehouse_id" v-on:click="check_one()">
                                                            <label class="pl-1 py-0 my-0" for="warehouse_id">WareHouse
                                                                Name</label>
                                                        </p>
                                                    </div>
                                                    <div class="align-items-center text-base ">
                                                        <p class="tag">
                                                            <input type="checkbox" name="quantity" id="quantity"
                                                                   v-model="query.quantity" v-on:click="check_one()">
                    ...
                    <div class="card-content">
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    <tr v-for="stock in warehouseStocks.data">
                                        <td class="text-left py-2 my-2">
                                            {{ stock.product ? stock.product.name:''}}
                                        </td>
                                        <td class="text-left py-2 my-2">{{
                                            (stock.ware_house ? stock.ware_house.name : '')
                                            }}
                                        </td>
            ...
            <div class="col-12 ">
                <pagination :links="warehouseStocks.links" class="float-right"></pagination>
            </div>
        </div>
    </admin-layout>
</template>
    ...
    methods: {
      ...
      if ((this.query.quantity = false)) {
        ...
        loadData() {
            ...
            this.$inertia.visit(route('warehouse-stocks.index'), {
                method: 'get',
                data: {
                    ...query
                }
