            ...
            <table class="table table-hover mb-0">
              ...
              <tbody>
                <tr v-for="product in products.data">
                  <td
                    class="text-right product-image py-0 pt-0 pb-0"
                  ...
                  >
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-right">
                        <a
                          :href="route('add.product.title', product.id)"
                          class="dropdown-item"
                          ><i class="bx bx-plus mr-1"></i>Product Title</a
                        >
                        <a
...
export default {
  ...
  methods: {
    ...
    deleteItem() {
      this.sweetAlert = false;
      this.$inertia.delete(`/erp/products/${this.itemId}`);
    },
    confirmDelete(id) {
    ...
    check_one: function () {
      ...
      if ((this.query.sales_report = false)) {
        this.query.sales_report = true;
        this.query.name = [];
        this.query.sku = [];
        this.query.rating = [];
        this.query.quantity = [];
