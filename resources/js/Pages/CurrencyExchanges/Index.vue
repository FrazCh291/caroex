  ...
  <admin-layout>
    <div class="col-12 px-0">
      <div class="col form-group p-0">
        <inertia-link
          :href="route('exchanges-rates.create')"
    ...
    <div class="row pb-3" id="table-hover-row">
                ...
                <div class="top d-flex flex-wrap">
                  ...
                  >
                    <div class="dropdown md:w-1/2 sm:w-1 pr-2 sort-dropdown">
                      <button
                        class="btn border dropdown-toggle w-125"
                        type="button"
                          ...
                          <div class="text-base pt-1">
                            <p class="tag">
                              <input
                                ...
                                name="value"
                                id="value"
                                v-model=" query.value" v-on:click="check_one()"
                              />
                              <label class="pl-1 py-0 my-0" for="value"
                                >To</label
                              >
                            </p>
                            <!-- <p class="tag">
                              ...
                              />
                              <label class="pl-1 py-0 my-0" for="amount"
                                >Amount</label
                              >
                            </p> -->
                            <p class="tag">
          ...
          <div class="card-content">
            <div class="table-responsive">
              <table class="table table-hover mb-0">
                <thead>
                  <tr>
                    <th class="custom-padding">From</th>
                    <th class="custom-padding">To</th>
                ...
                <tbody>
                  <tr
                    v-for="currencyExchange in currencyExchanges.data"
                  ...
                  <td>GBP</td>
                    ...
                    <!-- <td class="py-0 my-0 text-right">{{ currencyExchange.amount }}</td> -->
                      <td class="py-0 my-0 text-center">{{ formatDate(currencyExchange.created_at) }}</td>
                    <td class="text-right py-0 my-0 custom-padding-right">
                      <span class="d-inline-flex align-items-center">
                        <!-- <inertia-link
                          :href="route('exchanges-rates.edit', currencyExchange.id)"
                        >
                          <span
                            class="
                        ...
                        <button v-on:click="confirmDelete(currencyExchange.id)">
                          <span
     ...
     <ConfirmatiomModal v-if="sweetAlert" :sweetAlert="sweetAlert" @clicked="Clicked" @deleteitem="deleteItem"></ConfirmatiomModal>
             <div class="col-12 ">
                <pagination :links="currencyExchanges.links" class="float-right"></pagination>
            </div>
    </div>
  </admin-layout>
</template>
...
export default {
  ...
  beforeMount() {
    document.title = process.env.MIX_APP_NAME + " - Currency";
  ...
  methods: {
    ...
    deleteItem() {
      this.sweetAlert = false;
      this.$inertia.delete(`/super/admin/exchanges-rates/${this.itemId}`);
    },
    confirmDelete(id) {
    ...
    loadData() {
      ...
      this.$inertia.visit(route("exchanges-rates.index"), {
        method: "get",
        data: {
          ...query,
        },
