<template>
    <div>
        <div v-if="sweetAlert" class="swal2-container swal2-center swal2-fade swal2-shown"
            ...
            <div aria-labelledby="swal2-title" aria-describedby="swal2-content"
                ...
                <div class="swal2-actions" style="display: flex;">
                    <button type="button" class="swal2-confirm btn btn-primary" aria-label="" @click="confirmDelete">
                        Yes, delete it!
                    </button>
                    <button type="button" class="swal2-cancel btn btn-danger ml-1" aria-label=""
...
<script>
    export default {
        name: "ConfirmatiomModal",
        props: ['sweetAlert'],
        data() {
            return {
                cancelSweetAlert: false
            }
        },
        mounted() {
