<template>
    <div v-if="confirmationDelete" class="swal2-container swal2-center swal2-fade swal2-shown"
        ...
        <div aria-labelledby="swal2-title" aria-describedby="swal2-content"
            ...
            <div class="swal2-header">
                ...
                <div class="swal2-icon swal2-warning" style="display: none;"><span
                    class="swal2-icon-text">!</span></div>
            ...
            <div class="swal2-content">
                ...
                <label for="swal2-checkbox" class="swal2-checkbox" style="display: none;"><input
                    type="checkbox"><span class="swal2-label"></span></label><textarea class="swal2-textarea"
                                                                                       style="display: none;"></textarea>
                <div class="swal2-validation-message" id="swal2-validation-message"
                     style="display: none;"></div>
            </div>
            <div class="swal2-actions" style="display: flex;">
                <button type="button" class="swal2-confirm btn btn-success swal2-styled" aria-label=""
                        style="border-left-color: rgb(57, 218, 138); border-right-color: rgb(57, 218, 138);"
                        @click="successMethod">OK
                </button>
