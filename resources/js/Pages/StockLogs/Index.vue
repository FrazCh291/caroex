                  ...
                  <tr v-for="stockItem in stockLogs.data">
                    ...
                    <td class="text-right stock-tab">
                      <span class="d-inline-flex align-items-center">
                        <!--                                                <inertia-link :href="route('stock-logs.edit',stockItem.id)">-->
...
export default {
  ...
  methods: {
    ...
    deleteItem() {
      this.sweetAlert = false;
      this.$inertia.delete(`/fulfilment/admin/stock-logs/${this.itemId}`);

      this.$inertia.delete(`/erp/stock-logs/${this.itemId}`);
    },
    confirmDelete(id) {
    ...
    loadData() {
      ...
      this.$inertia.visit(route("stock-logs.index"), {
        method: "get",
        data: {
          ...query,
        },
