                    ...
                    <div class="col-md-9 col-12">
                        <div class="card">
                            <div class="card-header pb-0 mb-0">
                                <h4 class="card-title" v-if="core">Edit Core</h4>
                                <h4 class="card-title" v-else>Add Core</h4>
                                    ...
                                    <form @submit.prevent="submit" class="form form-horizontal">
                                        <div class="form-body">
                                            ...
                                            <div class="col-sm-11 d-flex justify-content-start px-0">
                                                ...
                                                <inertia-link :href="route('cores.index')" type="button"
...
export default {
    ...
    methods: {
        submit() {
            if (this.update) {
                this.form.post(route('cores.update', this.core.id))
            } else {
                this.form.post('/cores')
            }
        },
    }
}
