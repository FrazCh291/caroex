    ...
    <admin-layout>
        <div class="col-12 px-0">
            <div class="col form-group p-0">
                <inertia-link :href="route('cores.create')" class="btn btn-primary" data-repeater-create="">
                    Add Core
                </inertia-link>
            </div>
        </div>
                    ...
                    <div class="card-content">
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                <tr v-for="core in cores">
                                    <td class="text-left pl-2">{{ core.name }}</td>
                                    <td>{{ core.description }}</td>
                                    <td class="text-right">
                                            <span class="d-inline-flex align-items-center">
                                                <inertia-link :href="route('cores.edit',core.id)">
                                                ...
                                                <button v-on:click="confirmDelete(core.id)">
