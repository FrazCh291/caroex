<template>
  <admin-layout>
    ...
    <div class="row pb-3" id="table-hover-row">
                          ...
                          <div class="text-base pt-1">
                            ...
                            <p class="tag">
                              <input
                                ...
                                v-on:click="check_one()"
                              />
                              <label class="pl-1 py-0 my-0" for="slug"
                                >Slug</label
                              >
                            </p>
                            <p class="tag">
          ...
          <div class="card-content">
            <div class="table-responsive">
              <table class="table table-hover mb-0">
                <thead>
                  <tr>
                    <th class="channel-name text-left">Name</th>
                    ...
                    <td class="text-right py-0 my-0">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                          ...
                          <a
                            class="dropdown-item"
                            v-on:click="confirmDelete(channel.id)"
      ...
      <div class="col-12">
        <pagination :links="channels.links" class="float-right"></pagination>
      </div>
    </div>
  </admin-layout>
</template>
...
export default {
  ...
  beforeMount() {
    document.title = process.env.MIX_APP_NAME + " - Channels";
  },
  mounted() {
    if (this.params) {
  ...
  methods: {
    ...
    deleteItem() {
      this.sweetAlert = false;
      this.$inertia.delete(`/erp/admin/channels/${this.itemId}`);
    },
    confirmDelete(id) {
    ...
    loadData() {
      ...
      this.$inertia.visit(route("channels.index"), {
        method: "get",
        data: {
          ...query,
        },
