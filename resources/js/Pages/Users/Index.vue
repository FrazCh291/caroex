    ...
    <admin-layout>
        <div class="col-12 px-0">
            <div class="col form-group p-0">
                <inertia-link :href="route('users.create')" class="btn btn-primary" data-repeater-create="">
                    Add User
                </inertia-link>
            </div>
        </div>
                                                    ...
                                                    <div class="text-base pt-1">
                                                        <p class="tag">
                                                            <input type="checkbox" name="name" id="name"
                                                                   v-model="query.name">
                                                            <label class="pl-1 py-0 my-0" for="first_name">Name</label>
                                                        </p>
                                                        <p class="tag">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tr  v-for="user in users" :key="user.id">
                                    <td class="py-0 my-0">{{ user.name}}</td>
                                    <td class="py-0 my-0">{{ user.email}}</td>
                                    <td class="text-right py-0 my-0">
                                            <span class="d-inline-flex align-items-center">
                                                <inertia-link :href="route('users.show', 1)">
                                                ...
                                                <inertia-link :href="route('users.edit', 1)">
                                                    <span class="badge-circle badge-circle-light-secondary  action">
                                                        <i class="bx bx-edit font-medium-1 align-items-center text-center"></i>
                                                    </span>
                                                </inertia-link>
                                                <button v-on:click="confirmDelete(1)">
...
export default {
    ...
    methods: {
        ...
        deleteItem() {
            this.sweetAlert = false
            this.$inertia.delete(`/users/${this.itemId}`)
        },
        confirmDelete(id) {
