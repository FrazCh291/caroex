    ...
    <admin-layout>
        <div class="col-12 px-0">
            <div class="col form-group p-0">
                <inertia-link :href="route('modules.create')" class="btn btn-primary" data-repeater-create="">
                    Add Module
                </inertia-link>
            </div>
        </div>
        <div class="row pb-3" id="table-hover-row">
                                        ...
                                        <div id="DataTables_Table_0_filter" class="dataTables_filter">
                                            <div class="input-group form-group d-flex position-relative mt-1 px-2 pr-md-0">
                                                <input type="text" class="form-control border-light-gray btn-height"
                                                       placeholder="Search..."
                                                       aria-label="Search"
                                                       aria-describedby="basic-addon2"  v-model="query.query" @change="search">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tr v-for="module in modules.data">
                                    <td class="text-left pl-2">{{module.name}}</td>
                                    <td class="text-right">
                                        <div class="dropdown">
                                        ...
                                        <a :href="route('modules.edit',module.id)" class="dropdown-item"><i class="bx bx-edit-alt mr-1"></i>Edit</a>
                                        <a class="dropdown-item" v-on:click="confirmDelete(module.id)"><i class="bx bx-trash mr-1"></i>Delete</a>
                                        </div>
                                        </div>  
                                    </td>
                                </tr>
            ...
            <ConfirmatiomModal v-if="sweetAlert" :sweetAlert="sweetAlert" @clicked="Clicked"
                       ...
                       <div class="col-12 ">
                           <pagination :links="modules.links" class="float-right"></pagination>
                       </div>
        </div>
    </admin-layout>
</template>
...
export default {
    ...
    methods: {
        ...
        deleteItem() {
            this.sweetAlert = false
            this.$inertia.delete(`/super/admin/modules/${this.itemId}`)
        },
        confirmDelete(id) {
        ...
        loadData() {
            ...
            this.$inertia.visit(route('modules.index'), {
                method: 'get',
                data: {
                    ...query
                }
