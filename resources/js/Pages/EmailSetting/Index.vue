  ...
  <admin-layout>
    <div class="col-12 px-0">
      <div class="col form-group p-0">
        <inertia-link
          :href="route('email-settings.create')"
                        ...
                        <div class="col-12 pl-2 pt-1">
                          ...
                          <div class="text-base pt-1">
                            <p class="tag">
                              ...
                              />
                              <label class="pl-1 py-0 my-0" for="username"
                                >Username</label
                              >
                            </p>
                            <p class="tag">
                              <input
                                ...
                                name="channel_id"
                                id="email_account_id"
                                v-model="query.email_account_id"
                                v-on:click="check_one()"
                              />
                              <label
                                class="pl-1 py-0 my-0"
                                for="email_account_id"
                                >Channel
                              </label>
                            </p>
                            <p class="tag">
                              <input
                                ...
                                v-on:click="check_one()"
                              />
                              <label class="pl-1 py-0 my-0" for="protocol"
                                >Protocol</label
                              >
                            </p>
                            <p class="tag">
                    ...
                    <td class="text-right">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                          <a
                            :href="route('email-settings.edit', email.id)"
                            class="dropdown-item"
                            ><i class="bx bx-edit-alt mr-1"></i>Edit</a
                          >
                          <a
                            class="dropdown-item"
                            v-on:click="confirmDelete(email.id)"
...
export default {
  ...
  beforeMount() {
    document.title = process.env.MIX_APP_NAME + " - Cores";
  },
  mounted() {
    if (this.params) {
  ...
  methods: {
    ...
    deleteItem() {
      this.sweetAlert = false;
      this.$inertia.delete(`/erp/admin/email-settings/${this.itemId}`);
    },
    confirmDelete(id) {
    ...
    loadData() {
      ...
      this.$inertia.visit(route("email-settings.index"), {
        method: "get",
        data: {
          ...query,
        },
