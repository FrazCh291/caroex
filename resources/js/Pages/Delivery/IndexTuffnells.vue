    ...
    <admin-layout>
        ...
        <div class="row pb-3" id="table-hover-row">
            ...
            <div class="col-12">
             ...
             <div class="col-12 mt-2">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tr v-for="delivery_item in delivery.delivery_items">
                                    ...
                                    <td class="text-center" >{{delivery_item.order_items.product?delivery_item.order_items.product.name: ''}}</td>
                                    <td class="text-center" >{{delivery_item.order_items.order.shipping_address_1}}</td>
               ...
               <div class="col-12 mt-n2">
                ...
                <a :href="route('upload.manifest.file', this.tuffnelId)"
                                ...
                                <tr v-for="document in documents">
                                    ...
                                    <td class="text-right py-0 my-0 custom-padding-right">
                                            <span class="d-inline-flex align-items-center">
                                                <a :href="route('export.manifest.data.file', document.id)">
            ...
            <ConfirmatiomModal v-if="sweetAlert" :sweetAlert="sweetAlert" @clicked="Clicked"
                               ...
                               <div class="col-3">
                                   <inertia-link :href="route('deliveries.index')" type="button"
...
export default {
    ...
    methods: {
        ...
        deleteItem() {
            this.sweetAlert = false
            this.$inertia.delete(`/erp/del/manifest/${this.itemId}`)
        },
        ...
        loadData() {
            ...
            this.$inertia.visit(route('manifest.view'), {
                method: 'get',
                data: {
                    ...query
                }
