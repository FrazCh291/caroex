            ...
            <section id="basic-horizontal-layouts">
                <div class="row match-height">
                    ...
                    <div class=" card invoice-product-details table-responsive  ml-1">
                        <table class="table table-border-less ">
                            ...
                            <tr v-for="deliveryInspecte in deliveryInspection">
                                <td><input v-model="collected" :value="deliveryInspecte.id" class="mt-2"
                                           type="checkbox"></td>
                                <td class="PX-2 py-0 my-0 custom-padding">
                                    Next Day
                                </td>
                                <td class="py-0 PX-2 my-0">{{ deliveryInspecte.order.product.name }}</td>
                                                ...
                                                <div class="custom-popover popover-max">
                                                    <div class="d-flex justify-content">
                                                        ...
                                                        <p class="py-0 mb-0 small">
                                                            {{ deliveryInspecte.order.customer.name }}
                                                        </p>
                                                    ...
                                                    <div class="d-flex justify-content">
                                                        ...
                                                        &nbsp;&nbsp;
                                                        <p class="py-0 mb-0 small">
                                                            {{ deliveryInspecte.order.customer.phone }}
                                                        </p>
                                                    ...
                                                    <div class="d-flex justify-content">
                                                        ...
                                                        &nbsp;&nbsp;
                                                        <p class="py-0 mb-0 small">
                                                            {{ deliveryInspecte.order.customer.email }}
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="col-sm-11 d-flex justify-content-start px-0 ml-2">
                        ...
                        <inertia-link :href="route('deliveries.index')" class="btn btn-light-secondary mr-1 mb-1"
                                      type="button">
                            Back
                        </inertia-link>
                    </div>
...
export default {
    ...
    name: "show",
    props: ['delivery', 'deliveryInspection'],
    components: {
        Button,
        AdminLayout,
        Pagination,
    ...
    methods: {
        submit() {
            ...
            this.$inertia.visit('/erp/admin/delivery/inspected/store', {
                method: 'post',
