                                                ...
                                                <div class="col-md-6 form-group">
                                                    <select v-model="form.payer_currency_id" class="form-select"
                                                        ...
                                                        <option v-for="payercurrency in payercurrencys"
                                                            ...
                                                            {{ payercurrency.from_to?payercurrency.from_to:payercurrency.value}}
                                                        </option>
                                                    </select>
...
export default {
    name: "Create",
    props: ['suppliers','customerId', 'payercurrencys', 'payeeecurrencys', 'errors', 'methods', 'payeraccounts', 'payeeaccounts', 'payments', 'invoices', 'routeName', 'routeId', 'paymentInvoiceId', 'invoice'],
    ...
    methods: {
        submit() {
            if (this.update) {
                ...
                this.form.post(route('customer.payments.update', this.payments.id))
            } else {
                this.form.customer_id = this.customerId
                this.form.post('/erp/customer/invoices/payment/store')
            }
        },
        // getExchangeRate() {
        //     var currency = this.payercurrencys.find(payercurrency => payercurrency.slug == this.form.payer_currency_id);
        //             this.form.conversionrate = currency.amount;
        //             if(this.form.amount){
        //                 this.form.payee_total = (this.form.amount*this.form.conversionrate).toFixed(2);
        //                 return this.form.payee_total;
        //             }
        // },
        // calculateRate() {
        //     this.form.payee_total = (this.form.amount*this.form.conversionrate).toFixed(2);
