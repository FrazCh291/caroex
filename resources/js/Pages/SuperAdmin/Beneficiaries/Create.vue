          ...
          <div class="col-md-9 col-12">
            <div class="card">
              <div class="card-header pb-0 mb-0">
                <h4 class="card-title" v-if="beneficiary">Edit Beneficiary</h4>
                <h4 class="card-title" v-else>Add Beneficiary</h4>
              </div>
              <div class="px-2 pb-1">
                <hr class="line" />
              </div>
                  ...
                  <form @submit.prevent="submit" class="form form-horizontal">
                    <div class="form-body">
                      ...
                      <div class="col-sm-11 d-flex justify-content-start px-0">
                        ...
                        <inertia-link :href="route('companys.show', companyId)" type="button"
...
<script>
  ...
  export default {
    ...
    methods: {
      submit() {
        if (this.update) {
          this.form.post(route("beneficiaries.update", this.beneficiary.id));
        } else {
          this.form.company_id = this.companyId;
          this.form.post("/super/admin/beneficiaries");
        }
      },
    },
  };
