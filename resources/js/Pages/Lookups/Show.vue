          ...
          <div class="col-md-12 col-lg-12 col-xl-12 col-12">
            <div class="card invoice-print-area">
              ...
              <div class="card-content">
                <div class="card-body pb-1 mx-25 px-2">
                  <div>
                    <div v-if="company.parent_id == null" class="row pb-1">
                      ...
                      <div class="col-2">
                        <div class="col form-group pr-0 pb-0.5" >
                          <a data-repeater-create="" :href="route('shipment.create', company.id)">
                            <i class="
                                bx
                                bxs-plus-circle
                                pt-0.5
                    ...
                    <div class="row pb-0.5" v-if="shipments.length > 0">
                      <div class="col-12">
                        <div class="card">
                          <div class="card-content">
              ...
              <!-- 2nd -->
              <div class="card-content">
                <div class="card-body pb-0 mx-25 px-2">
                  <div>
                    <div class="row pb-1">
                      <div class="col-10">
                        <div class="mb-0 pt-0.5 lg:font-bold">
                      ...
                      <div class="col-2">
<!--                        <div class="col form-group pr-0 pb-0.5" >-->
<!--                          <a data-repeater-create="" :href="route('beneficiary.create', company.id)">-->
<!--                            <i class="-->
<!--                                bx-->
<!--                                bxs-plus-circle-->
<!--                                pt-0.5-->
...
<!--                      <div class="col-2">-->
<!--                        <div class="col form-group pr-0 pb-0.5">-->
<!--                          <a data-repeater-create="" :href="route('intermediary.create', company.id)"-->
<!--                            data-v-7709b240="">-->
<!--                            <i class="-->
<!--                                bx-->
<!--                                bxs-plus-circle-->
...
<!--              </div>-->
                                ...
                                <tbody>
                                  <tr v-for="address in addresses">
                                    ...
                                    <td class="
                                      ...
                                      <span class="d-inline-flex align-items-center">
                                        <inertia-link :href="
                                           route('company.addresss.edit', address.id)
                                          ">
                                          <span class="
                                              badge-circle
                                              badge-circle-light-secondary
              ...
              <div class="col-sm-11 d-flex justify-content-start px-2 mb-2">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      deleteItem() {
        this.sweetAlert = false;
        this.$inertia.delete(`/erp/admin/${this.controller}/${this.itemId}`);
      },
