    ...
    <admin-layout>
        <div class="col-12 px-0">
            <div class="col form-group p-0">
                <inertia-link :href="route('notifications.create')" class="btn btn-primary" data-repeater-create="">
                    Add Notification
                </inertia-link>
            </div>
        </div>
                                ...
                                <div class="top d-flex flex-wrap">
                                    ...
                                    <div class="actions action-btns d-flex align-items-center sort-dropdown pl-1">
                                        <div class="dropdown w-100 pr-2 sort-dropdown2">
                                            <button class="btn border dropdown-toggle w-100 disabled" type="button"
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tr v-for="notification in notifications">
                                    <td class="text-left pl-2">{{ notification.subject }}</td>
                                    <td>{{ notification.message }}</td>
                                    <td class="text-right">
                                            <span class="d-inline-flex align-items-center">
                                                <inertia-link :href="route('notifications.edit',notification.id)">
                                                ...
                                                <button v-on:click="confirmDelete(notification.id)">
...
export default {
    ...
    beforeMount() {
        document.title = process.env.MIX_APP_NAME + " - notifications";
    },
    mounted() {
        if (this.params) {
    ...
    methods: {
        ...
        deleteItem() {
            this.sweetAlert = false
            this.$inertia.delete(`/notifications/${this.itemId}`)
        },
        confirmDelete(id) {
