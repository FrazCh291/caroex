                    ...
                    <div class="col-md-9 col-12">
                        <div class="card mb-0">
                            <div class="card-header pb-0 mb-0">
                                <h6 class="d-inline-block">Building: {{ building.code }} </h6><span> - </span>
                                <h6 class="d-inline-block" v-if="section">Edit Section</h6>
                                <h6 class="d-inline-block" v-else>Add Section</h6>
                            </div>
                            <div class=" pb-1 px-2">
                                <hr class="line" />
                            </div>
                                    ...
                                    <form @submit.prevent="submit" class="form form-horizontal">
                                        <div class="form-body">
                                            ...
                                            <div class="row form-group pt-2 pb-0 mb-0">
                                                ...
                                                <div class="col-md-2 col-4   form-group">
                                                    <input type="number" id="length" v-model="length"
                                                        class="form-control" name="length" placeholder="length m"
                                                        min="0" max="9999" step=".01" required />
                                                    <ErrorComponent input="length"></ErrorComponent>
                                                </div>
                                                <div class="col-md-2 col-4  form-group">
                                                    <input type="number" id="height" v-model="height"
                                                        class="form-control" name="height" placeholder="height m"
                                                        min="0" max="9999" step=".01" required />
                                                    <ErrorComponent input="height"></ErrorComponent>
                                                </div>
                                                <div class="col-md-2 col-4 form-group ">
                                                    <input type="number" id="width" v-model="width" class="form-control"
                                                        name="width" placeholder="width m" min="0" max="9999" step=".01"
                                                        required />
                                            ...
                                            <div class="row form-group pt-2 pb-0 mb-0">
                                                ...
                                                <div class="col-md-6 form-group">
                                                    <input type="number" id="volume" disabled v-model="form.volume"
                                            ...
                                            <div class="col-sm-11 d-flex justify-content-start px-0">
                                                ...
                                                <inertia-link :href="route('building.show', [building.code])"
...
<script>
    ...
    export default {
        ...
        beforeMount() {
            ...
            if (this.section) {
                this.update = true;
                if (this.section.is_active == 1) {
                    this.section.is_active = 1 ? true : false
                }
                if (this.section.is_occupied == 1) {
                    this.section.is_occupied = 1 ? true : false;
                }
        ...
        methods: {
            submit() {
                if (this.update) {
                    this.form.post(route("section.update", this.section.id + "-" + this.building.id));
                } else {
                    this.form.post(route("section.store", { 'building_code': this.building.code, 'building_id': this.building.id }));
                }
            },
        },
    };
