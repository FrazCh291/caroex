                    ...
                    <div class="col-md-9 col-12">
                        <div class="card mb-0">
                            <div class="card-header pb-0 mb-0">
                                <h6 class="d-inline-block">Section: {{ section.code }} </h6><span> - </span>
                                <h6 class="d-inline-block" v-if="aisle">Edit Aisle</h6>
                                <h6 class="d-inline-block" v-else>Add Aisle</h6>
                            </div>
                            <div class=" pb-1 px-2">
                                    ...
                                    <form @submit.prevent="submit" class="form form-horizontal">
                                        <div class="form-body">
                                            ...
                                            <div class="col-sm-11 d-flex justify-content-start px-0">
                                                ...
                                                <inertia-link :href="route('building.show',building_code)" type="button"
...
<script>
    ...
    export default {
        name: "Create",
        props: ['aisle', 'errors', 'building_code', 'section'],
        components: {
            Label,
            AdminLayout,
            JetInputError,
        ...
        beforeMount() {
            ...
            if (this.aisle) {
                this.update = true;
                if (this.aisle.is_active == 1) {
                    this.aisle.is_active = 1 ? true : false;
                }
                if (this.aisle.is_occupied == 1) {
                    this.aisle.is_occupied = 1 ? true : false;
                }
                let data = this.aisle;
                Object.assign(data, {
                    _method: "PUT",
        ...
        methods: {
            submit() {
                if (this.update) {
                    this.form.post(route("aisle.update", this.aisle.id + "-" + this.building_code));
                } else {
                    this.form.post(route("aisle.store", { 'building_code': this.building_code, 'section_id': this.section.id }));
                }
            },
        },
    };
