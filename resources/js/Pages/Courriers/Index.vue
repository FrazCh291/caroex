    ...
    <admin-layout>
        <div class="col-12 px-0">
            <div class="col form-group p-0">
                <inertia-link :href="route('courriers.create')" class="btn btn-primary" data-repeater-create="">
                    Add Courrier Company
                </inertia-link>
            </div>
        </div>
        <div class="row pb-3" id="table-hover-row">
                                ...
                                <div class="top d-flex flex-wrap">
                                    ...
                                    <div
                                        ...
                                        <div class="dropdown md:w-1/2 sm:w-1 pr-2 sort-dropdown">
                                            <button class="btn border dropdown-toggle w-200" type="button"
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right py-0 my-0 custom-dropdown"
                                                ...
                                                <div class="col-12 pl-2 pt-1">
                                                    ...
                                                    <div class="text-base pt-1">
                                                        ...
                                                        <p class="tag">
                                                            <input type="checkbox" name="warehouseBuilding" id="warehouseBuilding"
                                                                   v-model="query.warehouseBuilding" v-on:click="check_one()">
                                                            <label class="pl-1 py-0 my-0" for="warehouseBuilding">warehouse</label>
                                                        </p>
                                                    </div>
                                                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tr>
                                    ...
                                    <th class="truncate text-center">warehouse Building</th>
                                ...
                                <tbody>
                                <tr v-for="courrier in courriers.data">
                                    <td class="">{{courrier.name}}</td>
                                     <td class="text-center">{{courrier.warehousebuilding.name}}</td>
                                     <td class=""></td>
                                    <td class=""></td>
                                    <td class=""></td>
                                    <td class=""></td>
                                    ...
                                    <td class="text-right custom-padding-right">
                                        ...
                                        <a :href="route('courriers.show',courrier.id)" class="dropdown-item"><i class="bx bx-show mr-1"></i>Show</a>
                                        <a  :href="route('courriers.edit',courrier.id)" class="dropdown-item"><i class="bx bx-edit-alt mr-1"></i>Edit</a>
                                        <a class="dropdown-item" v-on:click="confirmDelete(courrier.id)"><i class="bx bx-trash mr-1"></i>Delete</a>
                                        </div>
                                        </div>
                                    </td>
                                </tr>
            ...
            <ConfirmatiomModal v-if="sweetAlert" :sweetAlert="sweetAlert" @clicked="Clicked"
                      ...
                      <div class="col-12">
                          <pagination :links="courriers.links" class="float-right"></pagination>
                     </div>
        </div>
    </admin-layout>
</template>
...
export default {
    ...
    beforeMount() {
        document.title = process.env.MIX_APP_NAME + " - Courrier";
    },
    mounted() {
        if (this.params) {
    ...
    methods: {
        ...
        deleteItem() {
            this.sweetAlert = false
            this.$inertia.delete(`/super/admin/courriers/${this.itemId}`)
        },
        confirmDelete(id) {
        ...
        resetFilter() {
            ...
            this.query.warehouseBuilding = false;
            this.loadData();
        },
        search() {
     ...
     check_one: function () {
      ...
      if ((this.query.warehouseBuilding = false)) {
        this.query.warehouseBuilding = true;
        this.query.name = [];
      }
   },
        loadData() {
            ...
            this.$inertia.visit(route('courriers.index'), {
                method: 'get',
                data: {
                    ...query
                }
