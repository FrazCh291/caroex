    ...
    <admin-layout>
        <div class="col-12 px-0">
            ...
            <div class="col form-group p-0">
                <inertia-link :href="route('documents.create')" class="btn btn-primary" data-repeater-create="">
                    Add Documents
                </inertia-link>
            </div>
        </div>
                                ...
                                <div class="top d-flex flex-wrap">
                                    ...
                                    <div
                                        ...
                                        <div class="dropdown md:w-1/2 sm:w-1 pr-1 filter-dropdown">
                                            <button class="btn border dropdown-toggle w-100" disabled="disabled" type="button"
                                                ...
                                                <div class="col-12 pl-2 pt-1">
                                                    ...
                                                    <div class="align-items-center text-base pt-1">
                                                        ...
                                                        <p class="tag">
                                                            ...
                                                            <label class="pl-1 py-0 my-0" for="disable">Inactive</label>
                                                        </p>
                                                    </div>
                                                </div>
                    ...
                    <div class="card-content">
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                <thead>
                                <tr>
                                    <th class="supplier-name text-left">deal#</th>
...
export default {
    ...
    methods: {
        ...
        deleteItem() {
            this.sweetAlert = false
            this.$inertia.delete(`/deals/${this.itemId}`)
        },
        confirmDelete(id) {
