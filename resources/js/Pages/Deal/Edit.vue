            ...
            <div
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title font-weight-bold">Items</h4>
                        <button
                            aria-label="Close"
                            class="close"
                            data-dismiss="modal"
                    ...
                    <form class="form form-horizontal">
                        <div class="modal-body mb-1" id="modal-body-sec">
                            ...
                            <div class="form-group py-0 my-0 mb-1">
                                <label>Product</label>
                                <div class="col-md-12 form-group ml-0 pl-0">
                                    <select class="form-select" v-model="form2.product_id" name="product_id">
                                        <option value="">Select Item Name</option>
                                        <option
    ...
    export default {
        ...
        data() {
            return {
                ...
                dealDocs: this.deals ? this.deals.documents : [],
        ...
        beforeMount() {
            console.log(this.dealItems, "kasjldfkjlkasfd");
            if (this.deals) {
        ...
        methods: {
            ...
            deleteDealProduct(id) {
                ...
                if (!deal_item.deal_id) {
                    ...
                    this.form1.delete(route("deal.product.delete", deal_item.id));
                }
            },
            ...
            deleteDealDoc(id) {
                ...
                if (!deal_docs.documentable_id) {
                    ...
                    this.form.delete(route('document.deal.delete', deal_docs.id))
                }
            },
            ...
            deleteDealItemRate(id) {
                ...
                if (!deal_item_rate.deal_product_id) {
                    this.dealItemsRate = this.dealItemsRate.filter(function (rate) {
                        return rate.id !== id;
                    });
                } else {
                    this.form2.delete(route("deal.product.rate.delete", id));
                    this.dealItemsRate = this.dealItemsRate.filter(function (rate) {
                        return rate.id !== id;
                    });
                }
