    ...
    <div>
      <section id="basic-horizontal-layouts">
        <div class="row match-height">
                    ...
                    <div class="row pb-0.5">
                      ...
                      <div class="col-2">
                        <div class="col form-group pr-0 pb-0.5">
                          <inertia-link
                            :href="route('companys.users', company.id)"
                            class="px-0"
                          >
                            <i
                              class="
                              ...
                              <div data-repeater-list="group-a">
                                <div>
                                  <div class="top d-flex flex-wrap">
                                    ...
                                    >
                                      <div
                                        class="dropdown md:w-1/2 sm:w-1 pr-1"
                                      >
                                        <button
                                          class="
                                            btn
                                ...
                                <table class="table table-hover mb-0">
                                  <thead v-if="company.users.length > 0">
                                    <tr>
                                      ...
                                      <th
                                        class="py-0 my-0 text-truncate t-header"
                                      >
                                        Email
                                      </th>
                                      <th
                                  ...
                                  <tbody>
                                    ...
                                    >
                                      ...
                                      <td class="text-right action">
                                        ...
                                        >
                                          <button
                                            v-on:click="confirmDelete(userr.id)"
                                          >
                                            <span
                                              class="
                                                badge-circle
          ...
          <div
            class="col-lg-3 col-xl-3 col-md-6 col-12"
            v-if="company.subscription || is_super || is_admin"
          >
            <div class="card">
              <div class="card-content">
                  ...
                  <div class="row py-0">
                    <div class="col-md-12 form-group py-0 my-0">
                      <div class="position-relative has-icon-left">
                        <inertia-link
                          :href="route('company.roles', company.id)"
                        >
                          <span
                            class="btn btn-primary btn-lg btn-block text-small"
                            >Roles & Permissions
                          </span>
                        </inertia-link>
                      </div>
...
export default {
  ...
  methods: {
    ...
    deleteItem() {
      this.sweetAlert = false;
      this.$inertia.delete(
        `/fulfilment/admin/company/user/delete/${this.itemId}`
      );
    },
    confirmDelete(id) {
    ...
    check_one: function () {
      ...
      if ((this.query.role_id = false)) {
        this.query.role_id = true;
        this.query.name = [];
        this.query.email = [];
      }
    },
    loadData() {
      ...
      this.$inertia.visit(route("company.users.index"), {
        method: "get",
        data: {
          ...query,
        },
