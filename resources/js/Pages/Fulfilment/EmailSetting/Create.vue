                                    ...
                                    <form @submit.prevent="submit" class="form form-horizontal">
                                        <div class="form-body">
                                            ...
                                            <div class="form-body">
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-md-6 form-group">
                                                      ...
                                                      <ErrorComponent input="email_host"></ErrorComponent>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-11 d-flex justify-content-start px-0">
                                                ...
                                                <inertia-link :href="route('email-setting.index')" type="button"
...
export default {
    name: "Create",
    props: ['emailSetting', 'channels', 'errors'],
    components: {
        Label,
        AdminLayout,
        JetInputError,
    ...
    methods: {
        submit() {
            if (this.update) {
                this.form.post(route('email-setting.update', this.emailSetting.id))
            } else {
                this.form.post('/fulfilment/admin/email-setting')
            }
        },
    }
}
