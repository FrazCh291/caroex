...
export default {
    ...
    methods: {
        ...
        editOrder(id) {
            ...
            // var oldProduct = this.products.find(iteme => iteme.id === id);
            ...
            // var data = this.order.order_items.find(item => item.id === id);
            // this.order_idd = data.id;
        ...
        submit() {
            ...
            this.form.id = this.order.id ? this.order.id : '',
                this.form.post('/fulfilment/case')
