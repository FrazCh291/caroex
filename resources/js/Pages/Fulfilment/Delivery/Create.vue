                                    ...
                                    <form @submit.prevent="submit" class="form form-horizontal">
                                        <div class="form-body">
                                           ...
                                           <div class="col-sm-11 d-flex justify-content-start px-0">
                                                ...
                                                <inertia-link :href="route('deliveries.show', this.deliveryID)" type="button"
...
export default {
    ...
    methods: {
        ...
        submit() {
            if (this.update) {
                this.form.post(route('manifestsUpdate', this.editmanifest.id))
            } else {
                this.form.deliveryID = this.deliveryID
                this.form.post('/fulfilment/admin/importfile/manifest/file')
            }
        },
    }
}
